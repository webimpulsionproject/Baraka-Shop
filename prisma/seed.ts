...
async function main() {
  ...
  await prisma.product.createMany({
    data: [
      ...
      // ── Agneau ───────────────────────────────────────────────────
      { name: "Gigot d'Agneau Entier",            slug: "gigot-agneau",          category: "Agneau",        price: 22.90, weight: "env. 2kg",            image: IMG(LAMB),              description: "Gigot d'agneau de qualité supérieure, désossé ou avec os selon votre préférence. Découpe sur demande.",              badge: "Bestseller", inStock: true, stock: 12, decoupeOptions: true },
      { name: "Côtelettes d'Agneau",              slug: "cotelettes-agneau",     category: "Agneau",        price: 24.90, weight: "env. 120g/pièce",     image: fp(LAMB, 0.6, 0.35),    description: "Côtelettes tendres et parfumées, idéales au grill ou à la plancha. Marinade maison disponible.",                    inStock: true, stock: 20, decoupeOptions: true },
      { name: "Épaule d'Agneau Désossée",         slug: "epaule-agneau",         category: "Agneau",        price: 23.90, promoPrice: 19.90, promoEndDate: "2026-04-30T23:59:59Z", weight: "env. 1,2kg",   image: fp(LAMB, 0.25, 0.65),   description: "Épaule ficelée par notre boucher, fondante au four. Idéale pour les repas de famille.",                             badge: "Promo",      inStock: true, stock: 6,  decoupeOptions: true },
      { name: "Souris d'Agneau",                  slug: "souris-agneau",         category: "Agneau",        price: 18.50, weight: "env. 400g",           image: fp(SKEWER, 0.4, 0.5),   description: "Souris d'agneau confite, chair ultra-fondante. Idéale en tajine ou au four avec légumes.",                          inStock: true, stock: 15 },
      { name: "Collier d'Agneau",                 slug: "collier-agneau",        category: "Agneau",        price: 12.90, weight: "env. 500g",           image: fp(GROUND, 0.5, 0.35),  description: "Idéal pour les tajines et plats mijotés. Chair gélatineuse et savoureuse, fondante à la cuisson.",                   inStock: true, stock: 18 },
      { name: "Pack Découpe Aïd el-Adha",         slug: "pack-aide",             category: "Agneau",        price: 55.00, promoPrice: 45.00, promoEndDate: "2026-06-10T23:59:59Z", weight: "service complet", image: fp(LAMB, 0.8, 0.25),  description: "Mouton entier avec découpe complète sur place. Service premium avec emballage sous vide.",                          badge: "Aïd",        inStock: true, stock: 20, decoupeOptions: true },
      ...
      // ── Traiteur ─────────────────────────────────────────────────
      { name: "Brochettes Maison Mixtes",         slug: "brochettes-maison",     category: "Traiteur",      price: 18.90, weight: "env. 150g/brochette", image: IMG(SKEWER),            description: "Bœuf & agneau marinés aux herbes fraîches, préparées chaque matin par notre boucher.",                              badge: "Bestseller", inStock: true, stock: 20 },
      { name: "Colis Barbecue Premium",           slug: "colis-barbecue",        category: "Traiteur",      price: 59.90, promoPrice: 49.90, promoEndDate: "2026-05-01T23:59:59Z", weight: "~2kg",         image: fp(SKEWER, 0.6, 0.55),  description: "Merguez, brochettes, côtelettes et steaks hachés. Parfait pour 4 à 6 personnes.",                                  badge: "Promo",      inStock: true, stock: 10 },
      { name: "Kefta Maison",                     slug: "kefta-maison",          category: "Traiteur",      price: 15.90, weight: "env. 100g/pièce",     image: fp(SAUSAGE, 0.4, 0.6),  description: "Bœuf et agneau mélangés, parfumée au cumin et persil frais. Façonnée à la main.",                                   badge: "Bestseller", inStock: true, stock: 15 },
      { name: "Tajine d'Agneau Prêt à Cuire",     slug: "tajine-agneau",         category: "Traiteur",      price: 18.50, weight: "pour 2 pers.",         image: fp(LAMB, 0.5, 0.7),     description: "Tajine mariné aux épices marocaines avec légumes du marché. Prêt à mettre au four.",                                inStock: true, stock: 8 },

      // ── Épicerie Vrac ─────────────────────────────────────────────
      { name: "Ras el Hanout Premium",            slug: "ras-el-hanout",         category: "Épicerie Vrac", price: 6.90,  weight: "100g",                image: IMG(SPICES),            description: "Mélange marocain authentique de 25 épices. Idéal pour tajines, couscous et marinades.",                             badge: "Bestseller", inStock: true, origin: "🇲🇦 Maroc" },
      { name: "Cumin Entier Bio",                 slug: "cumin-entier",          category: "Épicerie Vrac", price: 4.50,  weight: "100g",                image: fp(SPICES, 0.65, 0.35), description: "Cumin entier de qualité premium, arôme intense et naturel. Idéal pour merguez et tajines.",                         inStock: true, origin: "🇮🇳 Inde" },
      { name: "Lentilles Vertes du Puy",          slug: "lentilles-vertes",      category: "Épicerie Vrac", price: 3.90,  weight: "500g",                image: fp(SPICES, 0.3, 0.65),  description: "Lentilles vertes AOP du Puy, riches en protéines et fibres. Label Rouge.",                                          inStock: true, origin: "🇫🇷 France" },
      { name: "Huile d'Olive Extra Vierge",       slug: "huile-olive",           category: "Épicerie Vrac", price: 12.90, weight: "500ml",               image: IMG(OLIVEOIL),          description: "Huile d'olive tunisienne première pression à froid. Goût fruité, acidité <0,5%.",                                   inStock: true, origin: "🇹🇳 Tunisie" },
      { name: "Thé Vert Gunpowder",               slug: "the-vert",              category: "Épicerie Vrac", price: 5.90,  weight: "100g",                image: fp(OLIVEOIL, 0.3, 0.4), description: "Thé vert roulé en billes, base traditionnelle du thé à la menthe. Saveur douce et légèrement boisée.",               inStock: true, origin: "🇨🇳 Chine" },
    ],
  });
