...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0F2314] text-white/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-white/35 text-[10px] tracking-wider uppercase mt-0.5">Boucherie Halal Premium</p>
              </div>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#1877F2]/80 hover:bg-[#1877F2] text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors"
            >
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-xs font-semibold text-white/35 uppercase tracking-widest mb-5">Navigation</h4>
            <ul className="space-y-2.5 text-sm">
              {[
                { href: "/",          label: "Accueil" },
                { href: "/produits",  label: "Nos Produits" },
                { href: "/epicerie",  label: "Epicerie Vrac" },
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-white/50">Dimanche — 9h30 – 20h00</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a href="mailto:contact.barakashop@gmail.com" className="text-white/50 hover:text-white transition-colors break-all">
                  contact.barakashop@gmail.com
                </a>
              </li>
              <li>
                <a href="https://barakashop.fr" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors">
                  barakashop.fr
                </a>
              </li>
            </ul>
