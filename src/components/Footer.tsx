        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              <li className="text-white/35">Lundi : Fermé</li>
              {[
                "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi",
              ].map((d) => (
                <li key={d} className="text-white/70">{d} : 8h30 – 20h00</li>
              ))}
              <li className="text-white/70">Dimanche : 9h30 – 20h00</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-white/70">
              ...
              <li>
                <a href="mailto:contact.barakashop@gmail.com" className="flex items-center gap-2 hover:text-white transition-colors break-all">
