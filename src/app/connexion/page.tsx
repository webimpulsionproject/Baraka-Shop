...
export default function ConnexionPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Compte admin
      if (email === "admin@barakashop.fr" && password === "admin123") {
    ...
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-playfair text-2xl font-bold text-gray-900 mt-5">Connexion</h1>
          <p className="text-gray-500 text-sm mt-1">Accédez à votre compte client</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <button type="button" className="text-xs text-[#E64A19] hover:underline">
                Mot de passe oublié ?
              </button>
            </div>
            <input
        ...
        <button
          type="button"
          onClick={() => alert("Google Auth — à configurer avec Firebase ou NextAuth.js")}
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/inscription" className="text-[#E64A19] font-semibold hover:underline">
            Créer un compte →
          </Link>
        </p>
