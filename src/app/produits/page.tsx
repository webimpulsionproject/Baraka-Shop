          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
              <div>
                ...
                <h1 className="font-playfair text-5xl font-bold text-white">Nos Produits</h1>
              ...
              <div className="relative w-full md:w-80">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl text-sm border-0 focus:outline-none focus:ring-2 focus:ring-white/20 bg-white/10 text-white placeholder-white/40"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#C62828] text-white py-3">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
              <p className="text-sm font-medium">
                <span className="font-bold">{promoCount} produits</span> en promotion cette semaine — jusqu&apos;a -20%
              </p>
              <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex items-center justify-between mb-8">
            <p className="text-sm text-gray-400">
              ...
              {cat !== "Tous" && (
                <> — <span className="text-[#1B5E20] font-medium">{cat}</span></>
              )}
            </p>
            {(search || cat !== "Tous") && (
              <button
